...
class MainActivity : AppCompatActivity() {
    ...
    private fun convertToPx(value: Int) : Int{
        val r = resources
        val px = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, value.toFloat(), r.displayMetrics).toInt()
        return px
    }
    ...
    private fun configureLayout() {
        ...
        set.connect(myEditText.id, ConstraintSet.BOTTOM, myButton.getId(), ConstraintSet.TOP,70)
